...
use Rack::Rewrite do
  ...
  r301 /(.*)\/index\.html$/i, 'http://personal-blog.herokuapp.com$1'
  ...
  r301 /.*/, 'http://personal-blog.herokuapp.com$&', if: proc { |rack_env| rack_env['SERVER_NAME'] != 'personal-blog.herokuapp.com' }
end
